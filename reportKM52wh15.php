...
<body>
    <br>
    <h3 class=" text-center">Report KM52 Warehouse 15</h3>
    <!-- <h5 class="text-center">Warehouse 0001</h5> -->
    ...
    <div class="col-lg-12 mx-auto">
      <div class="card rounded shadow border-0">
        <div class="card-body p-5 bg-white rounded">
          ...
          <?php
            $stmt = "SELECT * from BKP_WH_15 order by Date_sl desc ";
           ?>     
