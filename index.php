...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="images/logo_tsi_100-squashed.png" />
...
<body>
  <?php
  $stmt = "SELECT top 25 * from BKP_WH_15 order by Posting_Date desc ";
  // $params = array();
  // $options = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
  // $controws = 0;
  ?>
  ...
  <div class="cardform">
          ...
          ?>
            <tr>
              <form action="update.php" method="post">
                ...
                <td class="text-center"><?php echo $result["Date_sl"]; ?></td>
                <td class="text-center">
                  <font size="+1" color="#3745B5"><strong><input name="reqid" type="hidden" value="<?php echo $result["Product_Code"]; ?>" />
    ...
    <div class="row ">
      <div class="col-6 justify-content-center">
        <a class="btn btn-primary" href="report.php" role="button">ข้อมูลสรุปรายวัน</a>
      </div>
    </div>
  </div>
  </div>
